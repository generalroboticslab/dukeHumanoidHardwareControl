...
PYBIND11_MODULE(ethercat_motor_py, m)
{
   ...
   py::class_<PyMotor>(m, "PyMotor", py::dynamic_attr())
      ...
      .def_readwrite("gear_ratio", &PyMotor::gear_ratio)
      ...
      .def_readonly("dof_velocity_filtered", &PyMotor::dof_velocity_filtered)
      ...
      .def_readonly("target_dof_torque_A", &PyMotor::target_dof_torque_A)
      .def_readonly("target_dof_torque_A_adjusted", &PyMotor::target_dof_torque_A_adjusted)

      .def_readonly("loop_counter", &PyMotor::loop_counter)
